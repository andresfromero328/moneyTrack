...
import { setAccessToken } from "@/actions/setAccessTokenAction";
import { createLinkToken } from "@/actions/createLinkTokenAction";
...
const LinkToPlaid = ({ userID }: Props) => {
  ...
  */
  ...
  return (
    <button onClick={() => ready && open()} className="mx-auto mt-10">
      <BsBank2 />
